...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen text-center pt-30 bg-black bg-[linear-gradient(rgba(255,80,0,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,80,0,0.1)_1px,transparent_1px)] bg-[size:40px_40px] relative overflow-hidden border-b border-white/10">
