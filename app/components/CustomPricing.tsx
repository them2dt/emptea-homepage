      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center max-w-6xl mx-auto mt-6 md:mt-8 p-4 md:p-6 border-none rounded-lg bg-accent text-accent-foreground text-left gap-4 md:gap-0 mb-16">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
          ...
          <button 
            ...
            className="inline-flex items-center justify-center w-full md:w-auto px-4 md:px-6 py-2.5 md:py-3 rounded-md border border-black bg-white text-accent-foreground font-bold text-sm md:text-base cursor-pointer text-center transition-all duration-300 ease-in-out hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-accent"
          >
            Build Plan
          </button>
        </div>
