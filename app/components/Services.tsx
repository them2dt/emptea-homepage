  ...
  return (
    <section id="services" className="text-center py-8 md:py-12 px-4 md:px-6 bg-obsidian relative">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="font-bold text-2xl md:text-3xl lg:text-4xl text-primary-500 mb-6 md:mb-8 leading-tight max-w-3xl mx-auto">Crafted with precision, built to perform.</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
          <div className="group text-left bg-gradient-to-br from-gray-900/40 to-gray-900/20 rounded-lg p-5 md:p-6 transition-all duration-300 ease-in-out relative border border-gray-800/40 hover:border-primary-500/30 hover:bg-gradient-to-br hover:from-gray-900/60 hover:to-gray-900/30">
            ...
            <h3 className="font-bold text-lg md:text-xl mb-2 md:mb-3 text-white relative z-10 group-hover:text-primary-500 transition-colors duration-300">Web</h3>
          ...
          <div className="group text-left bg-gradient-to-br from-gray-900/40 to-gray-900/20 rounded-lg p-5 md:p-6 transition-all duration-300 ease-in-out relative border border-gray-800/40 hover:border-primary-500/30 hover:bg-gradient-to-br hover:from-gray-900/60 hover:to-gray-900/30">
            ...
            <h3 className="font-bold text-lg md:text-xl mb-2 md:mb-3 text-white relative z-10 group-hover:text-primary-500 transition-colors duration-300">Mobile</h3>
